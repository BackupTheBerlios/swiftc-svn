...
/* simd types */
%token  X64_SIMD_INT8  X64_SIMD_INT16  X64_SIMD_INT32  X64_SIMD_INT64  X64_SIMD_SAT8  X64_SIMD_SAT16
%token X64_SIMD_UINT8 X64_SIMD_UINT16 X64_SIMD_UINT32 X64_SIMD_UINT64 X64_SIMD_USAT8 X64_SIMD_USAT16 
%token X64_SIMD_REAL32 X64_SIMD_REAL64
...
load_store
    ...
    { 
        EMIT("mov" << suffix($2) << '\t' << memvar_index2str($3, $4, $1->getOffset()) << ", " << reg2str($1->resReg())) 
    }
